...
> Detailed setup instructions will be added after Phase 1.
...
See [docs/api_design.md](docs/api_design.md) for the complete REST API specification.

## Architecture Documentation

See [docs/architecture.md](docs/architecture.md) for system design, design patterns,
and technology choice justifications.

## Database Schema

See [docs/er_diagram.md](docs/er_diagram.md) for the ER diagram with field-level
detail and interview talking points.
